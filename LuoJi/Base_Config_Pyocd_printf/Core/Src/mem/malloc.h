...
#define MEM2_MAP_ADDR    0x68032000;  //(0x68000000 + MEM2_MAX_SIZE)
...
#define MEM3_MAP_ADDR      0x1000F000  //(0x10000000 + MEM3_MAX_SIZE)

// 定义字符串化宏
#define STRINGIFY_VALUE(x) STRINGIFY_HELPER(x)
#define STRINGIFY_HELPER(x) #x
#define SECTION_AT(addr) ".ARM.__at_" STRINGIFY_VALUE(addr)
